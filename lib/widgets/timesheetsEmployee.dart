...
class TimeSheetEmployee extends StatefulWidget {
  String employeeId;
  String startDate;
  String endDate;
  TimeSheetEmployee({Key key, this.employeeId, this.startDate, this.endDate})
      : super(key: key);
...
List<TimelogsForEmployee> _timesheets = [];

class _TimeSheetEmployeeState extends State<TimeSheetEmployee> {
  @override
  void initState() {
    super.initState();
